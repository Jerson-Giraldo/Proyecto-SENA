...
<script src="<?= URL_PATH ?>/Assets/js/producto.js"></script>-->
  ...
  <div class="col-12 col-md-4">
    ...
    <input class="form-control" type="date" id="fecha_ingreso" name="fecha_ingreso" value="<?= $parameters['producto']['fecha_ingreso'] ?? '' ?>">
  </div>
  <div class="col-12 col-md-4">
    <label class="form-label" for="fecha_salida">Fecha_salida</label>
    <input class="form-control" type="date" id="fecha_salida" name="fecha_salida" value="<?= $parameters['producto']['fecha_salida'] ?? '' ?>">
  </div>
  <div class="col-12 col-md-4">
