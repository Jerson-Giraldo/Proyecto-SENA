<form action="ProductoController.php" method="POST" id="productoFormulario" class="formulario-producto d-flex flex-column align-items-center justify-content-center">
  ...
  <div class="col-12 col-md-4">
    ...
    <input class="form-control type="text" id="detalles_de_factura_iddetalles_de_factura" name="detalles_de_factura_iddetalles_de_factura" value="<?= $parameters['producto']['detalles_de_factura_iddetalles_de_factura'] ?? '' ?>">
  </div>
  <div class="col-12 col-md-4">
